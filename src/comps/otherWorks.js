          ...
          <div className='otherContent' key={index}>
            <div>
              <div className='otherContentHead'>
                <a href={item.Website} rel="noopener noreferrer" target="_blank"> <img src={require(`./../assets/images/otherWorks/${item.Image}`)} alt='Screenshot' /></a>
                <div className='headPart'>
                <h4><a  href={item.Website} rel="noopener noreferrer" target="_blank">{item.Title}</a></h4>
